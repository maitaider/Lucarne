  ...
  return (
    <div className="flex h-full flex-col justify-around gap-3">
      {Array.from({ length: count[stage] }).map((_, i) => (
        <div
          key={i}
          className="rounded-lg border border-dashed border-border-subtle bg-surface-1/30 py-3 text-center"
        >
...
function BracketCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group relative block overflow-hidden rounded-lg border bg-surface-1/60 transition",
