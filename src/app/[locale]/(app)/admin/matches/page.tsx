      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-0.5 max-w-2xl text-sm text-text-tertiary">
            {fr
              ? "Saisis le score et les buteurs de chaque match. Passe le statut à « Terminé » pour régler automatiquement les pronostics et afficher le résultat sur les tableaux de bord."
              : "Enter the score and scorers for each match. Set the status to “Finished” to automatically settle predictions and surface the result on dashboards."}
          </p>
        </div>
      </div>
